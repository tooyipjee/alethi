      ...
      <main className="flex-1 flex items-center justify-center px-6 pb-20">
        <div className="w-full max-w-[340px]">
          <div className="text-center mb-10">
            <h1 className="text-[24px] font-semibold tracking-tight mb-2">Welcome back</h1>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-4 text-[12px] text-neutral-600">or sign in with email</span>
            </div>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-4 text-[12px] text-neutral-600">or</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-3 bg-neutral-950 border border-neutral-800 rounded-lg text-[14px] hover:bg-neutral-900 hover:border-neutral-700 transition-colors"
            >
